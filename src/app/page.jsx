            ...
            <div className="lg:max-w-[420px] xl:max-w-md flex flex-col gap-10 sm:gap-14 px-[5%] lg:px-0">
              ...
              <div className="flex flex-col gap-12">
                <div className="space-y-6">
                  <p className="text-3xl sm:text-4xl">YOUR SKIN DESERVES THE BEST CARE.</p>
                  <p className="text-sm">
                    Discover a curated collection of skincare products designed
                    to rejuvenate, protect, and pamper your skin. Explore our
                    rage crafted with love backed by science, and inspired by
                    nature.
                  </p>
                </div>
